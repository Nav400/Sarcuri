...
export default function HomePageBody() {
    return (
        <div className = {`${cinzel.className} leading-relaxed text-base sm:text-small md:text-lg lg:text-2xl space-y-6 mt-20 text-center`} style={{ wordSpacing: "2px" }}>
            ...
            <p>
                Sarcuri comes from the two parts "Sar" and "Curi". <em>Sar</em>, coming from the sanskrit word <em>Sarvada</em>, meaning always. <em>Curi</em> comes from the english word "curious." Together, the name Sarcuri translates to <strong>always curious</strong>.
            </p>
            <p>
